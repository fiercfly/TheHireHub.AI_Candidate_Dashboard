            ...
            >
                ...
                <div className={`flex items-center border-b border-slate-200 h-16 shrink-0 ${collapsed ? 'justify-center px-4' : 'px-5 gap-3'}`}>
                    <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 bg-white">
                        <img className='width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5"' src="https://www.thehirehub.ai/landing-page/ai.png" alt="hireHub.AI-logo" />
                    </div>
                    {!collapsed && (
